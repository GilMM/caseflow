      ...
      <Card
        ...
        title={
          <Space align="center" style={{ justifyContent: "space-between", width: "100%" }}>
            ...
            <Tag color="geekblue">{t("calendar.header.eventCount", { count: dayEvents.length })}</Tag>
          </Space>
        }
      >
        {dayEvents.length ? (
                ...
                <List.Item.Meta
                  ...
                  title={
                    <Space size={10} wrap>
                      ...
                      <Tag style={{ margin: 0 }}>{formatTimeRange(e, t)}</Tag>
                      {e.all_day ? <Tag color="blue">{t("calendar.event.allDay")}</Tag> : null}
                    </Space>
                  }
                  description={
          ...
          <Empty
            description={
              <Space orientation="vertical" size={2}>
                <Text>{t("calendar.event.noEvents")}</Text>
                <Text type="secondary" style={{ fontSize: 12 }}>
                  {t("calendar.event.noEventsHint")}
                </Text>
              </Space>
            }
          />
