    ...
    >
      <div
        style={{
          ...
          border: `1px solid ${token.colorBorderSecondary || token.colorBorder}`,
          background:
            "radial-gradient(400px 180px at 20% 20%, rgba(22,119,255,0.22), transparent 55%), radial-gradient(360px 160px at 80% 30%, rgba(82,196,26,0.18), transparent 55%)",
          flex: "0 0 auto",
          fontSize: 18,
        }}
      >
...
function LandingInner({ locale, isHebrew, linkPrefix }) {
  ...
  return (
    <div
      style={{
        ...
        padding: "24px 16px",
        background:
          "radial-gradient(1400px 700px at 30% 20%, rgba(22,119,255,0.18), transparent 60%), radial-gradient(1200px 600px at 70% 30%, rgba(82,196,26,0.14), transparent 55%), linear-gradient(180deg, rgba(0,0,0,0.65), rgba(0,0,0,0.92))",
      }}
    >
      <div style={{ width: "100%", maxWidth: 1120, padding: "0 4px" }}>
        <Card
          style={{
            ...
            overflow: "hidden",
            background:
              "radial-gradient(1200px 600px at 20% 10%, rgba(22,119,255,0.18), transparent 60%), radial-gradient(1000px 500px at 80% 20%, rgba(82,196,26,0.14), transparent 55%)",
          }}
            ...
            <Col xs={24} lg={12} style={{ padding: 28 }}>
              <Space orientation ="vertical" size={18} style={{ width: "100%" }}>
                <Space wrap size={8}>
                  ...
                  <Pill icon={<TeamOutlined />} label={isHebrew ? "צוותי" : "Team-based"} />
                </Space>
                ...
                <Space orientation ="vertical" size={12} style={{ width: "100%" }}>
                  ...
                  <Feature
                    token={token}
                    icon={<CloudOutlined style={{ color: token.colorPrimary }} />}
                  ...
                  <Space orientation ="vertical" size={20} style={{ width: "100%" }}>
                    <div style={{ textAlign: "center" }}>
                      ...
                      <Text type="secondary" style={{ fontSize: 14 }}>
                        {isHebrew ? "התחברו לחשבון קיים או צרו חשבון חדש" : "Sign in to your account or create a new one"}
                      </Text>
                    </div>
                    ...
                    <Space orientation ="vertical" size={12} style={{ width: "100%" }}>
                      ...
                      <Link href={`${linkPrefix}/register`} style={{ display: "block" }}>
                        <Button icon={<UserAddOutlined />} size="large" block style={{ height: 48, borderRadius: 10, fontSize: 15 }}>
                    ...
                    <Space orientation ="vertical" size={6} style={{ width: "100%" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                        <CheckCircleOutlined style={{ color: token.colorSuccess, fontSize: 14 }} />
                        <Text style={{ fontSize: 13 }}>{isHebrew ? "ללא צורך בכרטיס אשראי" : "No credit card required"}</Text>
                      </div>
                      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                        <CheckCircleOutlined style={{ color: token.colorSuccess, fontSize: 14 }} />
                        <Text style={{ fontSize: 13 }}>{isHebrew ? "תמיכה בעברית ואנגלית" : "Hebrew & English support"}</Text>
                      </div>
                    </Space>
                  </Space>
                </Card>

                {/* Links that Google checks on the homepage */}
                <div style={{ textAlign: "center", marginTop: 20 }}>
                  <Space split={<span style={{ color: token.colorTextQuaternary }}>|</span>} size={16}>
                    <Link href="/privacy" style={{ color: token.colorTextSecondary, fontSize: 13 }}>
                      {isHebrew ? "מדיניות פרטיות" : "Privacy Policy"}
                    </Link>
                    <Link href="/terms" style={{ color: token.colorTextSecondary, fontSize: 13 }}>
...
export default function LandingPublic() {
  ...
  return (
    ...
    >
      <LandingInner locale={locale} isHebrew={isHebrew} linkPrefix={linkPrefix} />
    </ConfigProvider>
  );
}
